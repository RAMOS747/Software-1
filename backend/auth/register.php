...
if ($stmt->fetch()) {
    jsonError('El correo que ingreso, ya se encuentra previamente registrado, ingrese uno diferente.');
}
...
jsonOk(['mensaje' => 'Registro exitozo, ya puede Iniciar sesion'], 201);
